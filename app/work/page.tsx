            ...
            <div className="md:col-span-7">
              <div className="grid grid-cols-2 gap-5">
                ...
                <a
                  ...
                  className="flex flex-col items-center justify-center gap-3 px-6 py-6 bg-ivory rounded-xl border border-[#d4ed39] hover:border-[#c8e050] hover:bg-white transition-all"
                >
