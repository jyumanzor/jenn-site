    ...
    <div className="bg-cream">
      ...
      <section className="py-12 bg-cream">
        <div className="container-editorial">
          <div className="grid md:grid-cols-12 gap-12 mb-8">
            <div className="md:col-span-4">
              <p className="light-bg-label mb-4">Side quests</p>
              <p className="light-bg-body text-sm leading-relaxed">
            ...
            <div className="md:col-span-7">
              <div className="grid grid-cols-2 gap-5">
                ...
                <a
                  ...
                  className="flex flex-col items-center justify-center gap-3 px-6 py-6 bg-ivory rounded-xl border-2 border-[#d4ed39] hover:border-[#c8e050] hover:bg-white transition-all"
                >
